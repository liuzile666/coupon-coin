...
**To Chen Yijun**, my girlfriend — you were not in the room while I wrote this, but you were on the other end of every hard night. You read drafts I was embarrassed to show anyone, told me which figure belonged on which page, and quietly fixed the colour on the landing page that I had been staring at for too long to see. A project like this is mostly loneliness; you made it a lot less lonely. There is a version of me that finished this dissertation and a version that did not, and the only difference between them is you.

**To Gao Zijun** — you did not write a line of this, but every idea I brought you came back sharper than it left. In March, when nothing was working, your belief in the project made quitting feel like letting you down. That is a rare weight for a friend to carry, and you carried it without ever making me feel watched.
