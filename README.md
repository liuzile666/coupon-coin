...
**To Chen Yijun**, my girlfriend — you carried the quiet half of this project. The half where dinner went cold because I was still debugging, where I was in the room but three chapters away. You never once made me feel guilty for the time this work took from us. There is a version of me that finished this dissertation and a version that did not, and the only difference between them is you.
